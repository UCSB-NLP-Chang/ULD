...
COMMON="data=harry trainer.batch_size=4 trainer.learning_rate=$lr trainer.gradient_accumulation_steps=8 model=mistral model_mode=base trainer.strategy=deepspeed OUTPUTMODELDIR=$OUTPUTMODELDIR"
